...
* 📄 **[Download FP1 Chapter 01: Rational Functions and Graphs](./examples/Sample_FP1_Chapter_01_Rational_functions_and_graphs.pdf)** - Generated by `questions_by_topic_chapters.py` for targeted quiz or homework.
* 📘 **[Download FP1 Complete Exercise Book](./examples/Sample_FP1_Exercise_Book.pdf)** - Generated by `questions_by_topic_book.py` for comprehensive revision.
